...
- LENGTH: average 40-60 words for a primary question; 70 words is a hard ceiling, never exceed it. Keep the opening contextual clause concise — one short anchor phrase, not a narrated scene-setting paragraph. If you're approaching the ceiling, you're narrating too much context, not asking too much — trim the setup, not the actual question.
...
- Target length: average 40–60 words for a primary question, 70 words is a hard ceiling — never exceed it. 15-25 words for a follow-up. If you're approaching the ceiling, you're narrating too much scene-setting, not asking too much — trim the opening context, not the actual question.
