 ...
 */
async function saveResumeIntelligence(userId, { rawText, resumeCompetencies, resumeContext }) {
  const result = await pool.query(
    `INSERT INTO career_profiles (user_id, resume_raw_text, resume_competencies, resume_context, resume_parsed_at)
     VALUES ($1, $2, $3, $4, NOW())
