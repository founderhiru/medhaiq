...
function buildVectorSection(scoreboard) {
  const vectors = [
    ['Career Intelligence (STAR)', scoreboard.career_intelligence, '#3b82f6'],
    ['Leadership Readiness',       scoreboard.leadership_readiness, '#a78bfa'],
    ['Executive Presence',         scoreboard.executive_presence,   '#22c55e'],
    ['GCC Readiness',              scoreboard.gcc_readiness,        '#f59e0b'],
