...
const plans = [
    ...
    featureGroups: [
      {
        ...
        items: [
          ...
          { text: '30 Welcome AI Minutes', bold: false },
  ...
  },
  {
    ...
    description: 'Everything you need to prepare for your next career move.',
    price: { INR: 999, USD: 12, EUR: 11 },
    priceSubtext: '120 AI Interview Minutes Included',
    minutes: 120,
    approxInterviews: 4,
    validityMonths: 12,
  ...
  },
  {
    ...
    priceSubtext: '300 AI Interview Minutes Included',
    minutes: 300,
    approxInterviews: 10,
    validityMonths: 12,
    validityLabel: 'Credits valid for 12 months',
